...
m_1: .word 2 
n_1: .word 3      
p_1: .word 1 2 3 4 5 6 # values of the first _matrix
m_2: .word 3 
n_2: .word 2
p_2: .word 1 2 3 4 5 6 #values of second matrix
m_3: .word 24 #garbage value
n_3: .word 24 #garbage value
p_3: .word 0
.text

#Size conformant matching
#--------------------------------------------
la gp L1
la t0 n_1
lw t2 0(t0)
la t1 m_2
lw t3 0(t1)
bne t2 t3 bad_exit #exit for no-size matching
#--------------------------------------------
# the size is m_1 x n_2, so store them in their locations
##size storing
#------------------------------
la t1 m_1
lw t0 0(t1)
...
sw t0 0(t3)
#-----------------------------
#loading necessary arguments, the sizes and the pointers
#-----------------------------------------------------------
la a1 p_1
la a2 p_2
la a3 p_3
